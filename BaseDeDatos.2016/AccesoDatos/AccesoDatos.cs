...
namespace AccesoDatos
{
    public class AccesoDatos
    {
        ...
        public AccesoDatos() 
        {
            ...
            this._conexion = new SqlConnection(Properties.Settings.Default.Coneccion);
            /*Para poder cambiar el nombre del default
            hay que ir al propiedades de acceso a datos a setting, cambiar el type a connection, scope a aplication y en value
